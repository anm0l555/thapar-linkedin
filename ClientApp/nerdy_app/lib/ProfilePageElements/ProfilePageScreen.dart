...
import '../StatsPageElements/StatsPageScreen.dart';
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.of(context).pop();
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => StatsPageScreen()));
                        }),
                  ],
                ),
                Container(
                  margin: EdgeInsets.only(
                      left: 1.1 * boxSizeH, right: .5 * boxSizeH),
                  height: 87 * boxSizeV,
                  child: ClipRRect(
                        ...
                        children: <Widget>[
                          ...
                          Center(
                            child: Container(
                              ...
                              child:
                                  Image.asset('images/Ducati_side_shadow.png'),
                            ),
                          ),
                        ],
                      ),
